const databaseURL = 'https://random-project-picker-23553-default-rtdb.europe-west1.firebasedatabase.app/.json';
  ...
  axios.get(databaseURL)
    .then(response => {
      ...
      const pickRandomProject = () => {
        const randomProject = Object.values(projects)[Math.floor(Math.random() * Object.keys(projects).length)];
